...
https://images/review.png

2.3 创建测试计划
进入【测试计划】，创建"登录功能测试计划"，关联5条功能用例。

https://images/test-plan.png

2.4 缺陷创建
执行测试计划时，发现"密码错误时提示信息不明确"，创建缺陷并关联测试用例。

https://images/bug.png

2.5 测试报告查看
执行完成后查看测试报告，通过率 100%，缺陷统计正常。

https://images/report.png
...
https://images/api-post-list.png
...
https://images/api-post-detail.png
...
https://images/api-post-content.png
...
接口文档：https://gitee.com/fit2cloud-edu/MeterSphere/blob/main/附件_1_Halo_接口文档_V2.2.mdhalo-test-cases
